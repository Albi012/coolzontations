...
public class RouteControllerTest {
    ...
    public void addParticipantToConsultation() throws Exception {
        ...
        Consultation optionalConsultation = Consultation.builder()
                ...
                .participantLimit(10)
                .build();
        userModelRepository.saveAndFlush(host);
    ...
    public void cancelConsultationParticipationAsParticipant() throws Exception {
        ...
        Consultation optionalConsultation = Consultation.builder()
                ...
                .participantLimit(10)
                .build();
        UserModel finalUserModel = userModelRepository.saveAndFlush(optionalUserModel);
        userModelRepository.saveAndFlush(host);
        consultationRepository.saveAndFlush(optionalConsultation);
        testEntityManager.clear();
        mvc.perform(MockMvcRequestBuilders
                .put("/api/consultation-participants")
                .contentType(MediaType.APPLICATION_JSON)
                .content("{\"userID\":" + optionalUserModel.getId() + "," +
                        " \"consultationID\": " + optionalConsultation.getId() + "}")
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
        assertThat(consultationRepository.findAll()).noneMatch(consultation -> consultation.getParticipants().contains(finalUserModel));
    }
    ...
    public void cancelConsultation() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders
                .delete("/api/cancel-consultation/" + consi.getId())
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
