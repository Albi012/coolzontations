...
//
//        ResponseEntity response = consultationDataService.joinConsultation(data);
...
//
//
//        ResponseEntity response = consultationDataService.createNewConsultation(consultation);
//        assertThat(response.getStatusCodeValue()).isEqualTo(200);
//
//        verify(userModelRepository, times(1)).findById(anyLong());
//        verify(consultationRepository, times(1)).saveAndFlush(any());
...
//
//        ResponseEntity response = consultationDataService.userReg(registrationUserModel);
//
//        assertThat(response.getStatusCodeValue()).isEqualTo(200);
//
...
//
//        ResponseEntity response = consultationDataService.cancelConsultation(2L);
//        assertThat(response.getStatusCodeValue()).isEqualTo(200);
//
//        verify(consultationRepository, times(1)).findById(anyLong());
